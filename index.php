...
<div class="wrapper">
  ...
  <header class="main-header" style="background-color: maroon;">

    <!-- Logo -->
    <a href="index.php" style="background-color: maroon;"  class="logo logo-bg">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>J</b>P</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg" style="color: white;"><b>Job</b> Portal</span>
    </a>
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav" style="background-color: maroon;">
          <li>
            <a href="jobs.php" style="color: white;">Jobs</a>
          </li>
          <li>
            <a href="#candidates" style="color: white;">Candidates</a>
          </li>
          <li>
            <a href="#company" style="color: white;">News</a>
          </li>
          <li>
          ...
          <li>
            <a href="sign-up.php" style="color: white;">Sign Up</a>
          </li>  
          <?php } else { 
          ...
          ?>        
          <li>
            <a href="user/index.php" style="color: white;">Dashboard</a>
          </li>
          <?php
          } else if(isset($_SESSION['id_company'])) { 
          ?>        
          <li>
            <a href="company/index.php" style="color: white;">Dashboard</a>
          </li>
          <?php } ?>
          <li>
