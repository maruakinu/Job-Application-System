      ...
      <div class="container">
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="create-news-post.php"><i class="fa fa-file-o"></i> Create News</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            <h2><i>Create News Post</i></h2>
            <div class="row">
              <form method="post" action="addnews.php">
                <div class="col-md-12 latest-job ">
                  <div class="form-group">
                    <input class="form-control input-lg" type="text" id="titles" name="titles" placeholder="News Title">
                  </div>
                  <div class="form-group">
                    <input type="text" class="form-control  input-lg" id="descriptions" name="descriptions" placeholder="Description" required="">
                  </div>
                  <div class="form-group">
